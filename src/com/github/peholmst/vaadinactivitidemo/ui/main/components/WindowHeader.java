package com.github.peholmst.vaadinactivitidemo.ui.main.components;

import com.github.peholmst.vaadinactivitidemo.ui.main.MainPresenter;
...
public class WindowHeader extends HorizontalLayout implements RefreshListener {
	...
	private VerticalLayout createTitle() {
		...
		Label appTitle = new Label("Vaadin Activiti Demo");
